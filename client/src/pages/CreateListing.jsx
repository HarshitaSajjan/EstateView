            ...
            <div className='flex flex-col gap-4 flex-1'>
                ...
                <div className='flex flex-wrap gap-6'>
                    <div className='flex items-center gap-2'>
                        <input type='number' id='bedrooms' min='3' max='10' required className='p-3 border border-gray-300 rounded-lg'/>
                        <p>Beds</p>
                    </div>
                    <div className='flex items-center gap-2'>
                        <input type='number' id='bathrooms' min='3' max='10' required className='p-3 border border-gray-300 rounded-lg'/>
                        <p>Baths</p>
                    </div>
                    <div className='flex items-center gap-2'>
                        <input type='number' id='regularPrice' min='3' max='10' required className='p-3 border border-gray-300 rounded-lg'/>
                        <div>
                           <p>Regular Price</p>
                    ...
                    <div className='flex items-center gap-2'>
                        <input type='number' id='discountPrice' min='3' max='10' required className='p-3 border border-gray-300 rounded-lg'/>
                        <div>
